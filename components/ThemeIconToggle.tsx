...
export default function ThemeIconToggle() {
  ...
  return (
    <button
      ...
      className="group rounded-full border border-[color:var(--border)] bg-[color:var(--card)]/80 backdrop-blur px-3 py-2 shadow-sm hover:bg-[color:var(--card)] focus:outline-none focus:ring-2 focus:ring-emerald-400/50"
    >
